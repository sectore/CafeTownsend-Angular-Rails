describe 'EmployeesController', ->
  ...
  beforeEach inject ($q, $rootScope, $controller) ->
    ...
    # services
    @employeesService =
      query: sinon.stub().returns @promise
    @selectedEmployee =
      instance: undefined
    @employeeResource =
  ...
  describe 'selected an employee', ->
    ...
    describe 'deleting an employee', ->
      ...
      it 'delete() of service is called', inject(($rootScope) ->
        @selectedEmployee.instance = @employeeResource
        @createController()
      ...
      it 'removes stored instance of selected employee', inject(($rootScope) ->
        @selectedEmployee.instance = @employeeResource
        @createController()
        @deferred.resolve()
        @scope.deleteEmployee()
